...
\newglossaryentry{c}{type=symbols,name={\ensuremath{c}},sort=c,
	description={The size of a context $Contex(w_t)$, i.e. the number of words before and after $w_t$}}
\newglossaryentry{C}{type=symbols,name={\ensuremath{C}},sort=C,
	description={The given corpus containing the sentences/documents of words }}
\newglossaryentry{contextWt}{type=symbols,name={\ensuremath{Contex(w_t)}},sort=contextWt,
